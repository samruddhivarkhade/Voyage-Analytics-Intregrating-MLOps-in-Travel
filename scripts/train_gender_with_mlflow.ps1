param(
    ...
    [string]$ExperimentName = "gender-classification",
    [string]$RegisteredModelName = "gender-classification-model",
    [switch]$StartUi,
    [int]$UiPort = 5000,
...
Write-Host "Running gender classification training script with MLflow tracking..." -ForegroundColor Green
& $pythonExe .\components\gender_classification_model.py
